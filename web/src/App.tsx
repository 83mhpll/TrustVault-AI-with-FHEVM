        ...
        <div className="container">
          <div className="hero">
            ...
            <div className="subtitle">
              Give confidential ratings (1–5). Sum and count are encrypted on-chain; averages are revealed via user
              decrypt.
            </div>
          ...
          <div className="card">
            ...
            <div style={{ color: "var(--muted)", fontSize: 14 }}>
              Choose a score from 1 to 5. Your rating is fully encrypted on-chain.
            </div>
            ...
            {tallies && (
              <div style={{ marginTop: 12 }}>
                <div className="progress">
                  <div
                    className="bar"
                    style={{ width: `${tallies[2] ? Math.min(100, (tallies[2] / 5) * 100) : 0}%` }}
                  />
                </div>
                <div className="footer">
